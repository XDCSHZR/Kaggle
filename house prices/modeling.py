...
# 平均(flag=0)/加权平均(flag=1)基本模型
class averageBaseModel(BaseEstimator, RegressorMixin, TransformerMixin):
...
#    best_score_LGB = 0.12246028009192222
    ...
    #-------------------------------集成融合------------------------------------
    # 基本模型平均/加权平均融合
    # model:['lasso', 'ENet', 'SVR', 'GBR'], score:0.1205827216025805
#    best_score_fusionModel = 0.12472772139487891
#    best_score_fusionModel = 0.1205827216025805
    print('fusionModel...')
#    baseModels = [clf_lasso, clf_ENet, clf_SVR, clf_GBR, clf_RFR]
#    baseScores = [best_score_lasso, best_score_ENet, best_score_SVR, best_score_GBR, best_score_RFR]
    baseModels = [clf_lasso, clf_ENet, clf_SVR, clf_GBR]
    baseScores = [best_score_lasso, best_score_ENet, best_score_SVR, best_score_GBR]
    clf_fusionModel = averageBaseModel(baseModels, baseScores)
    ...
    submission['SalePrice'] = clf_fusionModel_pred
